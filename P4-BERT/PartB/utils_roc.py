...
class InputExample(object):
    """A single training/test example for roc"""
    ...
    def __init__(self, example_id, contexts, endings, label=None):
        ...
        Args:
            ...
            contexts: list of str. First four sentences of the example.
            endings: list of str. Last two sentences of the example.
...
class RocProcessor(DataProcessor):
    """Processor for the Roc data set."""
...
def convert_examples_to_features(
    ...
    for (ex_index, example) in tqdm.tqdm(enumerate(examples), desc="convert examples to features"):
        ...
        label = label_map[example.label if example.label else "1"]

        if ex_index < 2:
            logger.info("*** Example ***")
            logger.info("roc_id: {}".format(example.example_id))
